...
- `main.c` – Programmets indgangspoint (`main`-funktion).  
...
- Træne C-sprogskompetencer som pointere, strukturer, funktioner og filstruktur.  
- Demonstrere forståelse for abstraktion og separation af kode i moduler.  
- Lave en simpel boarding-logik som en del af programmeringsøvelser på første semester.
